...
function fOverviewYear() {
  chartjsLineChartOne(
    ...
    (bColor = "#20C997"),
    (data = [
      95000, 19000, 55000, 90000, 240000, 95000, 55000, 19000, 55000, 66000,
      90000, 240000,
    ])
  );
  chartjsLineChartOne(
    ...
    (bColor = "#FF69A5"),
    (data = [
      98000, 20000, 55000, 90000, 240000, 95000, 55000, 19000, 55000, 66000,
      90000, 240000,
    ])
  );
  chartjsLineChartOne(
    ...
    (bColor = "#5F63F2"),
    (data = [
      9500, 1900, 5500, 9000, 24000, 9500, 5500, 1900, 5500, 9000, 10000, 24000,
    ])
  );
  chartjsLineChartOne(
    "#lineChartSixteen",
...
$("#se_device-week-tab").on("shown.bs.tab", function () {
  chartjsDoughnutExtra("chartDoughnut2WExtra", "146", (data = [483, 870, 420]));
  $("#se_device-week-tab").off();
});
...
$("#rb_device-week-tab").on("shown.bs.tab", function () {
  chartjsDoughnutExtra("chartDoughnut3WExtra", "146", (data = [450, 864, 450]));
  $("#rb_device-week-tab").off();
});
$("#rb_device-month-tab").on("shown.bs.tab", function () {
  chartjsDoughnutExtra(
